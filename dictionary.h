...
char * word_dictionary[] = {
   "aback", "abase", "abash", "abate", "abbey", "abbot", "abhor", "abide", "abled", "abode",
    ...
    "black", "blade", "blame", "bland", "blank", "blare", "blase", "blast", "blaze", "bleak",
    ...
    "brace", "braid", "brain", "brake", "brand", "brash", "brass", "brava", "brave", "bravo",
   ...
   "cabal", "cabby", "cabin", "cable", "cacao", "cache", "cacti", "caddy", "cadet",
    ...
    "chest", "chick", "chide", "chief", "child", "chili", "chill", "chime", "china",
    "chirp", "chock", "choir", "choke", "chord", "chore", "chose", "chuck", "chump",
    "chunk", "churn", "chute", "cider", "cigar", "cinch", "circa", "civic", "civil",
    "clack", "clade", "claim", "clamp", "clang", "clank", "clash", "clasp", "class", "clean",
    "clear", "cleat", "cleft", "clerk", "click", "cliff", "climb", "cling", "clink",
    "cloak", "clock", "clone", "close", "cloth", "cloud", "clout", "clove", "clown",
    "cluck", "clued", "clump", "clung", "coach", "coast", "cobra", "cocoa", "colon",
    "color", "comet", "comfy", "comic", "comma", "conch", "condo", "conga", "conic", "copse",
    "coral", "corer", "corny", "couch", "cough", "could", "count", "coupe", "court",
   ...
   "dacha", "daddy", "daffy", "daily", "dairy", "daisy", "dally", "dance", "dandy", "datum", "daunt",
    ...
    "dodge", "dodgy", "dogma", "doing", "doled", "dolly", "donor", "donut", "dopey", "doubt",
    "dough", "doula", "dowdy", "dowel", "downy", "dowry", "dozen", "draft", "drain", "drake",
   ...
   "fable", "facet", "faint", "fairy", "faith", "fakir", "false", "fancy", "fanny", "farce",
    ...
    "flesh", "flick", "flied", "flier", "fling", "flint", "flirt", "float", "flock", "flood",
    ...
    "forth", "forty", "forum", "found", "foyer", "frack", "frail", "frame", "frank", "fraud",
   ...
   "gabby", "gaffe", "gaily", "gamer", "gamma", "gamut", "gassy", "gaudy", "gauge", "gaunt",
    ...
    "glide", "glint", "gloat", "globe", "gloom", "glory", "gloss", "glove", "glued", "glyph",
    "gnash", "gnome", "godly", "going", "golem", "golly", "gonad", "goner", "gonna", "goody",
    "gooey", "goofy", "goose", "gorge", "gouge", "gourd", "grace", "grade", "graft",
    "grail", "grain", "grand", "grant", "grape", "graph", "grasp", "grass", "grate",
    "grave", "gravy", "graze", "great", "greed", "green", "greet", "grief", "grill",
    "grime", "grimy", "grind", "gripe", "groan", "groin", "groom", "grope", "gross",
   ...
   "habit", "hacky", "haiku", "hairy", "halve", "handy", "hanky", "happy", "hardy", "harem", "harpy", "harry",
    ...
    "image", "imbue", "impel", "imply", "inane", "inapt", "inbox", "incur", "index", "inept",
    ...
    "miser", "missy", "mixup", "mocha", "mochi", "modal", "model", "modem", "modus", "mogul", "moist", "molar",
    "moldy", "mommy", "money", "month", "mooch", "moody", "moose", "moral", "moron", "morph", "mossy",
    "motel", "motif", "motor", "motto", "moult", "mound", "mount", "mourn", "mouse", "mousy",
    "mouth", "mover", "movie", "mower", "mucky", "mucus", "muddy", "muggy", "mulch", "mummy",
    "munch", "mural", "murky", "mushy", "music", "musky", "mussy", "musty", "myrrh",
    "nabob", "nacho", "nadir", "naggy", "naive", "nanny", "nasal", "nasty", "natal", "naval", "navel", "needy",
    "neigh", "nerdy", "nerve", "never", "newer", "newly", "nicer", "niche", "niece",
    "night", "ninja", "ninny", "ninth", "noble", "nobly", "noise", "noisy", "nomad",
    "noose", "north", "nosey", "notch", "novel", "nudge", "nurse", "nutty", "nylon",
    "nymph",
    ...
    "piano", "picky", "piece", "piety", "piggy", "piled", "pilot", "pinch", "piney", "pinky",
    "pinto", "piper", "pique", "pitch", "pithy", "pivot", "pixel", "pixie", "pizza",
    "place", "plaid", "plain", "plait", "plane", "plank", "plant", "plate", "plaza",
    "plead", "pleat", "plebe", "plied", "plier", "pluck", "plumb", "plume", "plump", "plunk",
    "plush", "poach", "poesy", "point", "poise", "poker", "polar", "poled", "polka", "polyp", "pooch",
    "poppy", "porch", "poser", "posit", "posse", "pouch", "pound", "pouty", "power",
    "prank", "prawn", "preen", "press", "price", "prick", "pride", "pried", "prime",
    "primo", "print", "prior", "prism", "privy", "prize", "probe", "prole", "prone", "prong",
    ...
    "rabbi", "rabid", "racer", "radar", "radii", "radio", "radon", "rainy", "raise", "rajah",
    "rally", "ralph", "ramen", "ranch", "randy", "range", "rangy", "rapid", "rarer", "raspy",
    ...
    "rifle", "right", "rigid", "rigor", "riled", "rinse", "ripen", "riper", "risen", "riser",
    ...
    "segue", "seize", "semen", "sense", "sepia", "serif", "serum", "serve", "setup",
    "seven", "sever", "sewer", "shack", "shade", "shady", "shaft", "shake", "shaky",
    "shale", "shall", "shalt", "shame", "shank", "shape", "shard", "share", "shark",
    "sharp", "shave", "shawl", "shear", "sheen", "sheep", "sheer", "sheet", "sheik",
    "shelf", "shell", "shied", "shift", "shine", "shiny", "shire", "shirk", "shirt", "shiva",
    "shlep", "shoal", "shock", "shone", "shook", "shoot", "shore", "shorn", "short", "shout",
    "shove", "shown", "showy", "shrew", "shrub", "shrug", "shuck", "shunt", "shush",
    "shyly", "sidle", "siege", "sieve", "sight", "sigma", "silky", "silly", "since", "sinew",
    "singe", "siren", "sissy", "sixth", "sixty", "skate", "skier", "skiff", "skill",
    "skimp", "skirt", "skulk", "skull", "skunk", "slack", "slain", "slake", "slang", "slant",
    "slash", "slate", "sleek", "sleep", "sleet", "slept", "slice", "slick", "slide",
    ...
    "smoky", "smote", "snack", "snafu", "snail", "snake", "snaky", "snare", "snarf", "snark", "snarl", "sneak",
    ...
    "spout", "spray", "spree", "sprig", "spunk", "spurn", "spurt", "squad", "squat",
    "squib", "stack", "staff", "stage", "staid", "stain", "stair", "stake", "stale",
    "stalk", "stall", "stamp", "stand", "stank", "stare", "stark", "start", "stash",
    "state", "stave", "stead", "steak", "steal", "steam", "steed", "steel", "steep",
    "steer", "stein", "stern", "stick", "stiff", "still", "stilt", "sting", "stink",
    "stint", "stock", "stoic", "stoke", "stole", "stomp", "stone", "stony", "stood",
    "stool", "stoop", "store", "stork", "storm", "story", "stout", "stove", "strap",
    "straw", "stray", "strip", "strut", "stuck", "study", "stuff", "stump", "stung",
    "stunk", "stunt", "style", "suave", "sugar", "suing", "suite", "sulky", "sully",
    "sumac", "sunny", "super", "surer", "surge", "surly", "sushi", "swain", "swale", "swami", "swamp", "swank",
    "swang", "swarm", "swash", "swath", "swear", "sweat", "sweep", "sweet", "swell", "swept",
    ...
    "usher", "using", "usual", "usurp", "utile", "utter", "uvula",
    ...
    "wacko", "wacky", "wafer", "wager", "wagon", "waist", "waive", "waltz", "wanly", "warty", "waste",
    ...
    "wiled", "willy", "wimpy", "wince", "winch", "windy", "wiser", "wispy", "witch", "witty",
