...
char * word_dictionary[] = {
   ...
   "cabal", "cabby", "cabin", "cable", "cacao", "cache", "cacti", "caddy", "cadet",
    ...
    "caper", "caput", "carat", "cargo", "carol", "carry", "carve", "caste", "catch",
    ...
    "color", "comet", "comfy", "comic", "comma", "conch", "condo", "conic", "copse",
   ...
   "gaffe", "gaily", "gamer", "gamma", "gamut", "gassy", "gaudy", "gauge", "gaunt",
    "gauze", "gavel", "gawky", "gayer", "gayly", "gazer", "gecko", "geeky", "geese",
    ...
    "gnash", "gnome", "godly", "going", "golem", "golly", "gonad", "goner", "goody",
    ...
    "group", "grout", "grove", "growl", "grown", "gruel", "gruff", "grunt", "guard",
    "guava", "guess", "guest", "guide", "guild", "guile", "guilt", "guise", "gulch",
    "gully", "gumbo", "gummy", "guppy", "gusto", "gusty", "gypsy",
   "habit", "hairy", "halve", "handy", "happy", "hardy", "harem", "harpy", "harry",
    ...
    "junto", "juror",
    "kappa", "karma", "kayak", "kebab", "khaki", "kinky", "kiosk", "kitty", "knack",
    ...
    "nadir", "naive", "nanny", "nasal", "nasty", "natal", "naval", "navel", "needy",
    ...
    "shelf", "shell", "shied", "shift", "shine", "shiny", "shire", "shirk", "shirt",
    ...
    "sumac", "sunny", "super", "surer", "surge", "surly", "sushi", "swami", "swamp",
    "swarm", "swash", "swath", "swear", "sweat", "sweep", "sweet", "swell", "swept",
